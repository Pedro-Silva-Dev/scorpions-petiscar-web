...
export class ProductService extends BaseService {
	...
	public getPageProduct(build: Partial<ProductDetailViewParamBuild>, loadEvent?: BehaviorSubject<boolean>): Observable<HttpResponse<Page<ProductDetailView>>> {
	...
	public getListProduct(build: Partial<ProductDetailViewParamBuild>, loadEvent?: BehaviorSubject<boolean>): Observable<HttpResponse<ProductDetailView[]>> {
